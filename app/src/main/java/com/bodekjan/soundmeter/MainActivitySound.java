...
public class MainActivitySound extends Activity {
   ...
   TextView minVal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitysound_main);
       ...
       curVal=(TextView)findViewById(R.id.curval);curVal.setTypeface(tf);
        ...
        infoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InfoDialog.Builder builder = new InfoDialog.Builder(MainActivitySound.this);
